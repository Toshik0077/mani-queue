...
Login.prototype.render = function (parent) {
  ...
  this.elements.emailErrorMessage.textContent =
  ...
  this.elements.passErrorMessage.textContent =
  ...
  this.elements.emailInputContainer.append(
    this.elements.emailInputlabel,
    this.elements.emailInput
  );

  this.elements.passInputContainer.append(
    this.elements.passInputlabel,
    this.elements.passInput
  );

  this.elements.authForm.append(
    this.elements.emailInputContainer,
    this.elements.passInputContainer,
